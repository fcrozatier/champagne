...
<article class="layout-prose">
	...
	<p>
		We respect your data. This privacy policy lists the data we collect and explains how we use it
		when you navigate on the champagne website.
	</p>
